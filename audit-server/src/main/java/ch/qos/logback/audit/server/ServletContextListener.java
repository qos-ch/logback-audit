...
public class ServletContextListener implements javax.servlet.ServletContextListener {
	...
	public void contextInitialized(final ServletContextEvent sce) {
		...
		final String portStr = servletContext.getInitParameter(AuditServerConstants.PORT_INIT_PARAM);
		...
		final String rdbmsDialect = servletContext.getInitParameter(AuditServerConstants.RDBMS_DIALECT_INIT_PARAM);
		...
		final Properties props = ResourceUtil.getProps(applicationName + "/hibernate.properties");
